...
@objc protocol JYPageViewDelegate: class {
  @objc optional func pageView(_ pageView: JYPageView, didSelectPageAt index: Int)
  @objc optional func pageView(_ pageView: JYPageView, viewDidSwitchPageAt index: Int)
}
